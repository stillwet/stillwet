import {
  ...
  replaceOrderReturnClaimPlaceholders,
  type OrderReturnClaimEmailVars,
...
export const ORDER_RETURN_CLAIM_CONFIRMATION_SUBJECT = `We received your ${BRAND_MERCH_NAME} item claim`;

export const ORDER_RETURN_CLAIM_CONFIRMATION_HTML_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
      ...
      <tr><td align="center">
        <table role="presentation" width="100%" style="max-width:520px;background:#18181b;border:1px solid #27272a;border-radius:12px;padding:24px 20px;">
          <tr><td>
            ...
            <p style="margin:0 0 12px;font-size:14px;font-weight:600;color:#fafafa;">Claim received</p>
            <p style="margin:0 0 16px;font-size:13px;line-height:1.5;color:#a1a1aa;">
              Thanks for contacting ${BRAND_MERCH_NAME} support. We received your item claim and will review it.
            </p>
            ...
            <p style="margin:16px 0 0;font-size:11px;line-height:1.5;color:#71717a;">
              If you did not submit this claim, you can ignore this message.
            </p>
          </td></tr>
        </table>
      </td></tr>
...
export function renderOrderReturnClaimConfirmationHtml(
  template: string,
...
export function sampleOrderReturnClaimEmailVars(): OrderReturnClaimEmailVars {
  return {
