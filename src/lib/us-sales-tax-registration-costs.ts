...
export const US_SALES_TAX_REGISTRATION_COST_BY_STATE: Record<string, UsSalesTaxRegistrationCost> = {
  ...
  AZ: { label: "$12", renewalLabel: "Annual" },
  AR: { label: "Free", renewalLabel: "No expiry" },
  CA: { label: "Free", renewalLabel: "No expiry" },
  CO: { label: "Free", renewalLabel: "Every 2 yr" },
  CT: { label: "Free", renewalLabel: "Auto (2 yr)" },
  ...
  NV: { label: "$15", renewalLabel: "No expiry" },
  ...
  WA: { label: "Free", renewalLabel: "No expiry" },
  WV: { label: "Free", renewalLabel: "No expiry" },
