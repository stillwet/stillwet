          ...
          >
            ...
            {s.flair ? (
              <div className="mt-1 flex justify-center">
                <ShopFlairBadge
                  label={s.flair.label}
                  className="inline-flex items-center gap-1.5 rounded-full border border-zinc-800 bg-zinc-950/40 px-2 py-0.5 text-[9px] font-medium text-zinc-300"
                />
              </div>
            ) : null}
            {s.bio ? (
